...
async function detectClaudeCodeVersion(): Promise<string> {
	...
	if (explicit !== undefined) {
		...
		throw new Error("FireCode: PI_CLAUDE_CODE_VERSION 必须是 major.minor.patch 格式的 Claude Code 版本号。");
	}
	...
	throw new Error(
		"FireCode: 无法在 10 秒内读取 Claude Code 版本。请确认 PATH 中的 claude --version 正常，" +
